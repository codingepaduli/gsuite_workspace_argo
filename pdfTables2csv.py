...
# USAGE: python3 pdfTables2csv.py ./dati_argo/cdc/docenti_classi_2025_26.pdf output.csv --skip_duplicate_header --remove_newlines

# Configurazione del parser degli argomenti
parser = argparse.ArgumentParser(description='Estrai tabelle da un file PDF e salvale in un file CSV.')
parser.add_argument('pdf_file_path', type=str, help='Percorso del file PDF da elaborare.')
parser.add_argument('--skip_duplicate_header', action='store_true', help='Salta l\'intestazione durante l\'estrazione delle tabelle.')
